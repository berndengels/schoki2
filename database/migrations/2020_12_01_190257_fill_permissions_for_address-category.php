...
class FillPermissionsForAddressCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAddressCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'address-category',
            'address-category.index',
            'address-category.create',
            'address-category.show',
            'address-category.edit',
            'address-category.delete',
            'address-category.bulk-delete',
        ]);
