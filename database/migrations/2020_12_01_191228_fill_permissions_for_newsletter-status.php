...
class FillPermissionsForNewsletterStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNewsletterStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'newsletter-status',
            'newsletter-status.index',
            'newsletter-status.create',
            'newsletter-status.show',
            'newsletter-status.edit',
            'newsletter-status.delete',
            'newsletter-status.bulk-delete',
        ]);
