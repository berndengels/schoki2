...
<head>
    ...
    <meta name="keywords"
          content="Schokoladen,Berlin,Musik,Musik Cafe,Kneipe,Kultur,Szene,Subkultur,Konzerte,Livemusik,live music,Veranstaltungs-Kneipe,Veranstaltungen,Lesung,alternativ"/>
    ...
    <script src="{{ asset('js/header-app.js') }}" type="text/javascript" charset="utf-8"></script>
    @yield('extra-headers')
</head>
<body>
    ...
    <div class="background_right h-100">
        <img class="h-100 img-responsive" src="/img/the_dark_art.png" width="66px" height="718px" alt="Darkside"
             title="Darlside">
    </div>
