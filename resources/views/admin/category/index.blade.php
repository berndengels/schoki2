                ...
                <div class="card">
                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing table-striped">
                                <thead>
                                    <tr>
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger px-3" @click="bulkDelete('/admin/categories/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                                ...
                                <tbody>
                                    <tr v-for="(item) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
