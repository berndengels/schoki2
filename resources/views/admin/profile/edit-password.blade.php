...
@section('title', trans('admin.admin-customer.actions.edit_password'))
            ...
            <profile-edit-password-form
                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="action">
                    ...
                    <div class="card-header">
                        <i class="fa fa-pencil"></i> {{ trans('admin.admin-customer.actions.edit_password') }}
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('password'), 'has-success': fields.password && fields.password.valid }">
                            ...
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                <input type="password" v-model="form.password" v-validate="'required|min:7'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('password'), 'form-control-success': fields.password && fields.password.valid}" id="password" name="password" placeholder="{{ trans('admin.admin-customer.columns.password') }}" ref="password">
