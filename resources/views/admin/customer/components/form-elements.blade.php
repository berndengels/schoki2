...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('email'), 'has-success': fields.email && fields.email.valid }">
    <label for="email" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.email') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.email" v-validate="'required|email'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('email'), 'form-control-success': fields.email && fields.email.valid}" id="email" name="email" placeholder="{{ trans('admin.customer.columns.email') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('email_verified_at'), 'has-success': fields.email_verified_at && fields.email_verified_at.valid }">
    <label for="email_verified_at" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.email_verified_at') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('password'), 'has-success': fields.password && fields.password.valid }">
    <label for="password" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.password') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('password_confirmation'), 'has-success': fields.password_confirmation && fields.password_confirmation.valid }">
    <label for="password_confirmation" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.password_repeat') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('stripe_id'), 'has-success': fields.stripe_id && fields.stripe_id.valid }">
    <label for="stripe_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.stripe_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.stripe_id" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('stripe_id'), 'form-control-success': fields.stripe_id && fields.stripe_id.valid}" id="stripe_id" name="stripe_id" placeholder="{{ trans('admin.customer.columns.stripe_id') }}">
        <div v-if="errors.has('stripe_id')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('stripe_id') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('card_brand'), 'has-success': fields.card_brand && fields.card_brand.valid }">
    <label for="card_brand" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.card_brand') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.card_brand" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('card_brand'), 'form-control-success': fields.card_brand && fields.card_brand.valid}" id="card_brand" name="card_brand" placeholder="{{ trans('admin.customer.columns.card_brand') }}">
        <div v-if="errors.has('card_brand')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('card_brand') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('card_last_four'), 'has-success': fields.card_last_four && fields.card_last_four.valid }">
    <label for="card_last_four" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.card_last_four') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.card_last_four" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('card_last_four'), 'form-control-success': fields.card_last_four && fields.card_last_four.valid}" id="card_last_four" name="card_last_four" placeholder="{{ trans('admin.customer.columns.card_last_four') }}">
        <div v-if="errors.has('card_last_four')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('card_last_four') }}</div>
    </div>
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('trial_ends_at'), 'has-success': fields.trial_ends_at && fields.trial_ends_at.valid }">
    <label for="trial_ends_at" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.customer.columns.trial_ends_at') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
